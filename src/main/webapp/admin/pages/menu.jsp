              ...
              <div id="navlist-wraper">
                <ul id="navlist" class="nav nav-list">
                  <li class="current hasSub">
                    ...
                    <ul class="sub-nav">
                      <li>
                        <a  href="javascript:;" data-url="${pageContext.request.contextPath}member/v_list.do">
                          <i class="icon icon-circle"></i>
                          <span class="txt">会员管理</span>
                        </a>
                      </li>
                      <li>
                        <a  href="javascript:;" data-url="${pageContext.request.contextPath}group/v_list.do">
                          <i class="icon icon-circle"></i>
                      ...
                      <li>
                        <a  href="javascript:;" data-url="${pageContext.request.contextPath}role/v_list.do">
                          <i class="icon icon-circle"></i>
                          <span class="txt">角色管理</span>
                        </a>
                      </li>
                      <li>
                        <a  href="javascript:;" data-url="${pageContext.request.contextPath}log/v_list_log.do">
                          <i class="icon icon-circle"></i>
                          <span class="txt">后台操作日志</span>
                        </a>
                      </li>
                      <li>
                        <a  href="javascript:;" data-url="${pageContext.request.contextPath}log/v_list_login_success.do">
                          <i class="icon icon-circle"></i>
                          <span class="txt">登录成功日志</span>
                        </a>
                      </li>
                      <li>
                        <a  href="javascript:;" data-url="${pageContext.request.contextPath}log/v_list_login_failure.do">
                          <i class="icon icon-circle"></i>
                          <span class="txt">登录失败日志</span>
                        </a>
                      </li>
                      <li>
                        <a  href="javascript:;" data-url="${pageContext.request.contextPath}message/v_list.do">
                          <i class="icon icon-circle"></i>
                  ...
                  <li class="hasSub">
                    ...
                    <ul class="sub-nav">
                      <li>
                        <a href="javascript:;" data-url="<%=basePath%>news/v_list.do">
                          <i class="icon icon-circle"></i>
                          <span class="txt">新闻管理</span>
                        </a>
                      </li>
                      <li>
                        <a href="javascript:;" data-url="内容类型.html">
                          <i class="icon icon-circle"></i>
                          <span class="txt">新闻类型</span>
                        </a>
                      </li>
                      <li>
