...
<head>
	...
	<script type="text/javascript">
		...
		function optDelete(id) {
			...
			window.location = "<%=basePath%>news/o_delete.do?id="+id;
		}
	</script>
</head>
<body>
	<div class="container">
		<div class="toolbar">
			<div class="crumbs">
				<a href="#">新闻</a> -&gt; <a href="#">新闻管理</a> -&gt; <span>新闻列表</span>
			</div>
			<div class="action">
				<a href="news/v_add.do" class="btn" target="_self">添加</a>
			</div>
		</div>
		<div class="mod">
			<div class="bd">
    		<table class="ui-table">
    			...
    			<tbody>
    			<c:forEach var="flag" items="${newsPager.pageList}" varStatus="status">
    				<c:choose>
    					...
    					<c:otherwise>
    						<tr class="even">
								...
								<td>${flag.title}</td>
								<td>
									<a class="btn" href="news/v_update.do?id=${flag.id}">修改</a>
			...
			<!-- /.mod-bd -->
			<div class="ft">
		    	<pg:pager items="${newsPager.total}" maxPageItems="10" maxIndexPages="10" url="news/v_list.do" export="currentPageNo = pageNumber">
